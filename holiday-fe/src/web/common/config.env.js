...
switch (config_env) {//根据当前环境类型定义不同变量值
  case 'prod':
    base_url='http://imp-holiday-be.daily.app.yyuap.com';
...
export default {
  ...
  HTTP_PRINT_DATA_SERVERURL:'http://imp-holiday-be.daily.app.yyuap.com/bill/print', //打印的回调的数据地址
  HTTP_USER_LOGIN: '/user/authorize',
  domainCode:'IMP',//打印需要的域code值
